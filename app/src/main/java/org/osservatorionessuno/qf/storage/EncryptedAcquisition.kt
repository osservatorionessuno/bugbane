...
import org.osservatorionessuno.qf.crypto.ArchiveWriter
import org.osservatorionessuno.qf.crypto.EncryptedArchive
...
class EncryptedAcquisitionWriter(
    ...
    private val writer = ArchiveWriter(FileOutputStream(File(acquisitionDir, ARCHIVE_FILE)), vault)
...
class EncryptedAcquisitionReader(
    ...
    override fun forEachArtifact(block: (AcquisitionArtifact) -> Unit) {
        ...
        EncryptedArchive.forEachEntry(archive, vault) { name, modifiedTime, stream ->
