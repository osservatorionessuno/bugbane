...
object AcquisitionScanner {
    ...
    private fun scanWithIndicators(context: Context, acquisitionDir: File, indicatorsDir: File): File {
        ...
        fun collect(artifact: org.osservatorionessuno.libmvt.common.Artifact?) {
        ...
        if (File(acquisitionDir, ARCHIVE_FILE).exists()) {
            ...
            // Legacy plaintext-directory acquisition.
            runner.streamLegacyAnalysisFromDirectory(acquisitionDir).forEach { (_, artifact) -> collect(artifact) }
        }
